...
ggplot(dfRFM, aes(factor(RFM_Score))) +
  geom_bar() +
  ggtitle('Customer Distribution', subtitle = "Using RFM segments") +
...
- [Creating an RFM Summary Using Excel](http://www.brucehardie.com/notes/022/) by Peter Fader and Bruce Hardie (2008) 