...
Changes in train dataset must be applied to test dataset.
...
Does not appear to be any noticeable difference (in general we need to repeat this operation for all the variables).
